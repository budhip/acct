...
// Source: ./internal/repositories/mysql/mysql_tx.go
//
// Generated by this command:
//
//	mockgen -source=./internal/repositories/mysql/mysql_tx.go -destination=./internal/repositories/mysql/mock/mysql_tx_mock.go -package=mock
//
